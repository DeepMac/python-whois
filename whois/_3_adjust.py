# Purpose: Defines the "Domain" class used in this module while also handling metadata normalization
...
# Declare the class for holding domain whois data
class Domain:
	# Definie the class initialztion function
	def __init__(self, data: Dict[str, Any]):
		# All values pass in as dictionary. Any dict keys not used here are ignored.
		# Convert all inputs to lowercase and strip newlines/whitespace.
		...
		# This section deals with the fact that multiple nameservers are registered for most domains.
...
# Special formats not covered by normal standards
CUSTOM_DATE_FORMATS = {
	'ml' : '%m/%d/%Y',
}

# Define function to convert a string to python date object
def str_to_date(
	text: str,
